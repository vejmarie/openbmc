...
SYSTEMD_ENVIRONMENT_FILE_${PN} += "obmc/gpio/port_owner_udc2"
...
SYSTEMD_LINK_${PN} += "${@compose_list(d, 'FMT_GPIO', 'UDC2_GPIO')}"
...
SYSTEMD_LINK_${PN} += "${@compose_list(d, 'FMT_VEHCI', 'UDC2_VEHCI')}"
